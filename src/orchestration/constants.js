...
export const GENERATION_START_REGISTRY_SEAL_UPDATE =
  "oos.generation-start-registry.seal.v1";
export const GENERATION_START_REGISTRY_SEAL_UPDATE_ID_PREFIX =
  "oos:generation-start-registry-seal:v1";
export const GENERATION_START_REGISTRY_SEAL_FAILURE_TYPE =
  "OOS_GENERATION_START_REGISTRY_SEAL_NOT_AUTHORIZED";
export const GENERATION_START_REGISTRY_MAX_REGISTRATIONS = 512;
export const GENERATION_START_REGISTRY_CAPACITY_FAILURE_TYPE =
