...
const OPTIONAL = ["source_packet_ref", "target_delivery_ref", "accepted_delivery_target_receipt_ref"];

export function createPrototypeClosureOwnerReadbackService({ baselineReader, deliveryReader }) {
